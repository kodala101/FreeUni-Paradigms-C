...
typedef int (*VectorCompareFunction)(const void *elemAddr1, const void *elemAddr2); //saidan icis ra zomis elementebi sheadaros
...
typedef struct {
  ...
  int alocLen;
  int elemSize;
  VectorFreeFunction freeFunction;  //pointeri ranairadaa esa
} vector;
